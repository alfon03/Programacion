...
public class Main {
	...
	public static void main(String[] args) throws MemoryStorageException, PublicacionesException {
		...
		System.out.println(Valoraciones.MUYMALA.getValoracion());
		Publicacion p = new Recomendacion(
				"El Doble Elefante Telépata De Guerra es un elefante que concede deseos pedidos a Aquandrius por Finn en \"El Límite\". ",
				new Usuario("Chapero", "Fran"), 4);
		p.valorar("Muy buena");
