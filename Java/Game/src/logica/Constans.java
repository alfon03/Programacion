...
public class Constans {
	...
	// Número de elementos en el tablero
	...
	// Tipos de elementos en el tablero
	...
	// Resultados de las luchas entre jugadores
	public static final int EMPATE = 0; // Hay empate, ninguno de los dos gana la lucha
	public static final int GANA_USA_POCIMA = 1; // Gana el jugador y se utiliza la pócima del enemigo para que no muera
	...
	public static final int PIERDE_USA_POCIMA = 4; // Gana el enemigo y se utiliza la pócima del jugador para que no
													// muera
	...
	// Resultados de interacciones entre jugador y roca
